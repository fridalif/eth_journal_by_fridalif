...
from .views import RegisterRequestsAPIView, LessonAPIView, LessonStudentInfoAPIView, SubjectAPIView, GroupAPIView, \
    AbstractKidAPIView, AbstractTeacherAPIView, ProfileRaitingAPIView, ChangePasswordAPIView, ChangeUsernameAPIView
...
urlpatterns = [
    ...
    path('change_username/', ChangeUsernameAPIView.as_view(), name='change_usernames')
]
